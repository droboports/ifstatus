...
Check the [releases](https://github.com/droboports/ifstatus/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/ifstatus.git
cd ifstatus
./build.sh
ls -la *.tgz
```
